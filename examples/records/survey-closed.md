...
searches:
  - tool: "grep -rnE (BSD grep, macOS)"
    ...
    scope: >-
      every claim and question file in a private working collection of
      corpora
    hits_reported: "0"
...
notable_results:
  - what: "A doc-class granted dimension in a corpus's own documentation"
    note: >-
      One corpus's own documentation describes a doc-class field
      `granted: true`; a render-layer dimension of that document class,
      and the word's nearest live relative, not a record field.
  - what: "A grant rationale surviving as prose"
    note: >-
      One claim's working notes carry a grant rationale in prose; the

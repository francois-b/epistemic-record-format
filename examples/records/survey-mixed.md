...
searches:
  ...
  - tool: "semantic_search (local vector-index tool over a private research library)"
    query: >-
      reliability of legal citators, disagreement between Shepard's and
      KeyCite on treatment classification
    hits_reported: "15 passages returned; 7 on point, all tracing to sources already captured in this corpus"
notable_results:
  - what: >-
      Hellyer, Evaluating Shepard's, KeyCite, and BCite for Case
      Validation Accuracy, Law Library Journal 110:4 (2018)
    note: >-
      The largest statistical citator comparison to date (357 citing
      relationships); top result on both web probes; captured in this
      corpus 2026-07-19.
    atoms: [kwg-014, kwg-015, kwg-016]
  - what: >-
      The earlier comparison-study line: Shapiro 1998, McKenzie 1999,
      Taylor 2000 (Law Library Journal)
    note: >-
      Named in Hellyer's own literature review and surfaced independently
      by the second probe; the ground has been studied for 25+ years.
  - what: >-
      LexisNexis, Shepard's Signal vs. Westlaw KeyCite: Comparing
      Citators Across 1,000 Cases
    note: >-
      A vendor-run comparison; the vendors themselves participate in the
      literature.
  - what: >-
      Validate Your Authority: Benchmarking LLMs on Multi-Label Precedent
      Treatment Classification (arXiv, 2026)
    note: >-

...
import { loadCorpus, KNOWN_FIELDS } from "../../implementations/yaml-markdown/typescript/validate.ts";
...
// DESIGN-HISTORY.md split into docs/ on 2026-08-25; design-history.md inherited
...
const HISTORY = new Set(["docs/design-history.md", "docs/non-goals.md", "CHANGELOG.md"]);
...
for (const [name, script, args] of [
  ...
  ["every artifact's version against the specification's (implementations.yaml)", "lint/lint-versions.py", []],
] as const) {

...
history and its own specific use of LLMs.  <!-- claims: scope-excludes-coding ai-tooling-is-further-along-for-coding-than-for-knowledge-work "for the wider spectrum of knowledge work it's still the Wild West" bound-at=2026-08-25 -->
...
most of that work away, which is why it's timely to give it a second chance.  <!-- claims: km-1990s-failed-on-the-cost-of-manual-maintenance llm-economics-remove-the-labour-that-sank-km "the manual work it took to build and maintain created too much friction" bound-at=2026-08-25 -->
...
AI-flavored prose, recycled from call to call, degrades quickly.  <!-- claims: grounded-material-lowers-hallucination-risk-downstream recycled-llm-prose-degrades-quickly "recycled from call to call, degrades quickly" bound-at=2026-08-25 -->
...
behind them.  <!-- claims: epistemology-means-tracking-provenance-and-trust "tracking provenance and trust so that a written assertion can be relied on" bound-at=2026-08-25 -->

Managing those connections is a whole layer that is not yet mainstream. This
document describes what it would mean to build that layer.  <!-- claims: an-epistemic-layer-is-missing-from-knowledge-work-tooling "a whole layer that is not yet mainstream" bound-at=2026-08-25 -->
...
- **Epistemic types for text.** Mainstream tools file text by subject, format,
  ...
  and a ruling are different things, and the tools need to tell them apart.  <!-- claims: mainstream-tools-file-text-by-subject-format-author-and-date trust-tracking-is-confined-to-niches-and-done-by-hand file-text-by-epistemic-type "has been tracked only in niches, and by hand" bound-at=2026-08-25 -->
- **Grounding every piece of information.**
  - *Third party:* Every claim should point back to its sources, and the links
    ...
    about context and intent (see the three kinds of check in section 2).  <!-- claims: atom-is-one-quote-from-one-source "one quote from one source, small enough to support a single point" bound-at=2026-08-25 -->
  - *First party:* We need to know whether a person or an AI tool produced
    ...
    the ones the LLM filled in for you.  <!-- claims: no-tool-records-human-versus-ai-authorship without-attribution-past-verdicts-cannot-be-separated "at a finer grain than today's tools record" bound-at=2026-08-25 -->
- **Recording human judgment.** More information means more decisions to make,
  ...
  there is next to no tooling for it.  <!-- claims: recording-human-judgment-has-next-to-no-tooling "there is next to no tooling for it" bound-at=2026-08-25 -->
- **Deliberate human attention.** Human attention is finite, and knowledge work
  ...
  mistakes, re-checking what has already been verified).  <!-- claims: tools-must-not-create-chores-of-their-own "they should never create chores of their own" bound-at=2026-08-25 -->
- **Governance of AI itself.** "AI governance" covers at least three
  ...
  regulated industries, from what companies are doing.  <!-- claims: the-workspace-layer-is-absent-from-ai-governance "This last layer is missing from the AI-governance conversation" bound-at=2026-08-25 -->
- **Working with others.** Everything above has been tested within a one-person
  ...
  on beforehand.  <!-- claims: the-approach-is-untested-beyond-one-person sharing-requires-semantic-and-pragmatic-interoperability pragmatic-interoperability-is-an-established-term "what the literature calls pragmatic interoperability" bound-at=2026-08-25 -->
...
- **Diagnosing the missing pieces.**
  - _Primitives need to be mechanical for a working discipline to form._ Code
    ...
    crystallized.  <!-- claims: disciplines-form-around-mechanical-primitives knowledge-work-lacks-the-three-mechanical-primitives code-review-formed-around-diff continuous-integration-formed-around-automated-tests "Code review formed around diff, continuous integration around tests" bound-at=2026-08-25 -->
  - _It's tempting to aim for goals that are too broad._ Primitives for
    ...
    picked a use case along with workflow constraints, and frustrate users for that very reason.  <!-- claims: general-primitives-fail-on-the-specific-versus-open-tension general-purpose-knowledge-primitives-have-repeatedly-failed successful-saas-picked-a-use-case-with-workflow-constraints "have failed again and again" bound-at=2026-08-25 -->
  - _A lot of manual work has traditionally been involved_. Building,
    ...
    clean-up or drop it entirely.  <!-- claims: pkm-is-broadly-manual-work crm-decays-because-it-must-be-maintained-by-hand enterprise-wikis-go-stale-and-are-cleaned-up-or-abandoned "A CRM has to be maintained by hand" bound-at=2026-08-25 -->
- **Building primitives, disciplines, and surfaces.** Software engineering
  ...
  any particular LLM, and each new LLM makes them more useful.  <!-- claims: memory-and-graph-tools-have-not-moved-beyond-pre-llm-work no-tool-adds-checked-provenance-claim-checking-or-standing records-and-disciplines-outlast-any-particular-llm "What none of them add is a primitive for checked provenance" bound-at=2026-08-25 -->
- **Performing three kinds of check.** A syntactic check looks only at the
    ...
    being checked.  <!-- claims: three-kinds-of-check-are-distinct checks-mechanize-in-the-order-syntactic-semantic-pragmatic unstructured-prose-defeats-checking "Syntactic checks mechanize reliably, semantic checks partially" bound-at=2026-08-25 -->
...
each do one thing and compose.  <!-- claims: pieces-must-be-separately-adoptable separability-improves-the-odds-of-adoption "Keeping them separable is a design decision" bound-at=2026-08-25 -->
...
- **Grounding: a capture format and its verification tooling.** An atom
  ...
  whether the quote actually supports it (see the glossary in section 5).  <!-- claims: atom-is-one-quote-from-one-source entailment-is-the-cold-reader-test "checked for entailment, whether the quote actually supports it" bound-at=2026-08-25 -->
- **First-party attribution: a record of who wrote what.** Today's tools don't
  ...
  who made the change, person or AI.  <!-- claims: google-docs-records-authorship-no-finer-than-the-document git-records-changes-without-recording-ai-use cursor-blame-marks-ai-written-lines-with-their-model grammarly-authorship-is-a-per-document-sidecar-in-its-own-app author-built-a-save-time-authorship-shadow-record "The nearest thing for prose is Grammarly's authorship report" bound-at=2026-08-25 -->
- **Endorsement: a dated registry of standing.** Claims store what you think
  ...
  documents are assembled from claims, which is a topic for another doc.  <!-- claims: standing-is-operator-only-and-dated "only the operator moves it" bound-at=2026-08-25 -->
- **The governance layer: document contracts, committed and linted.** This is
  ...
  governance and it is where most of the value turned out to be.  <!-- claims: governance-was-where-most-of-the-value-turned-out-to-be llm-fit-sharpened-the-authors-document-thinking the-workspace-governance-layer-is-where-the-value-is "The solution was to add more governance" bound-at=2026-08-25 -->
- **The interaction surface: a native UI.** Tools of my own for reading,
  ...
  every power user of Claude Code has felt the limitations.  <!-- claims: speech-to-text-became-ubiquitous-in-2026 "Speech-to-text became ubiquitous in 2026" bound-at=2026-08-25 -->

What I do not know is how this breaks at larger scale. My system holds
500+ atoms, with one operator, in about six months.  <!-- claims: author-system-holds-500-atoms-one-operator-six-months the-one-operator-evidence-base-bounds-every-claim "My system holds 500+ atoms, with one operator, in about six months" bound-at=2026-08-25 -->
...
- **Data analysis keeps chasing data capture.** The web was meant to be
  ...
  is again racing to catch up.  <!-- claims: the-semantic-web-vision-produced-an-unstructured-web "The web was meant to be semantic but what accumulated was unstructured" bound-at=2026-08-25 -->
- **Knowledge management is coming back to the forefront.** Search engines,
  ...
  the people side, and its descendants are the company-brain startups.  <!-- claims: knowledge-is-text-you-can-check-combine-and-stand-behind knowledge-engineering-descends-to-palantirs-ontologies "Knowledge engineering in the 1980s came at it from the formal side" bound-at=2026-08-25 -->
- **A new iteration of Agile.** When iterating on software became faster, new
  ...
  original Agile field.  <!-- claims: agile-began-when-software-iteration-got-faster knowledge-work-gets-its-own-agile "this was the start of Agile, with short iterations, continuous integration, and refactoring" bound-at=2026-08-25 -->
...
- **"Brain" describes no mechanism.** "Company brain" was a Y Combinator
  ...
  nothing.  <!-- claims: company-brain-was-a-yc-request-for-startups-for-summer-2026 company-brain-products-ship-permission-aware-retrieval-with-agents company-brain-names-no-mechanism "The word anthropomorphizes and specifies nothing" bound-at=2026-08-25 -->
- **The records under retrieval are missing.** The unit in those products is
  ...
  what this document builds.  <!-- claims: page-grain-explains-the-three-absences company-brain-citations-are-not-checked notion-and-guru-verify-whole-pages-and-let-them-lapse nothing-records-authorship-below-the-grain-of-a-whole-page "The unit in those products is the page or the chunk, not the claim" bound-at=2026-08-25 -->
- **The industry is racing to the top of that stack.** Agentic AI is being
  ...
  structure that hasn't had time to emerge outside of coding.  <!-- claims: agentic-marketing-outruns-its-substrate "Agentic AI is being marketed while much of what sits underneath it is underserved" bound-at=2026-08-25 -->
...
- **Entailment** (section 3): whether the quote actually supports the
  ...
  surrounding context, accept the claim?  <!-- claims: entailment-is-the-cold-reader-test three-kinds-of-check-are-distinct atom-is-one-quote-from-one-source standing-is-operator-only-and-dated "would a reader holding only the quote, with its surrounding context, accept the claim?" bound-at=2026-08-25 -->

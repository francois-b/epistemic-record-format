...
export function buildServer(ws: Workspace): McpServer {
  ...
  server.registerTool("erf_narrative_status", { title: "Poll a narrative", description: "The narrative's digest, flags and bindings, without its text: what an open editor polls to see when a passage has been bound and a flag resolved. Read-only and cheap; it writes nothing.", inputSchema: { corpus: corpusArg, narrative: z.string().describe("narrative slug, or its path") } }, on("erf_narrative_status", (c, a) => T.narrativeStatus(c, a)));

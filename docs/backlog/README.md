...
| [`B-48`](B-48-the-validator-conformance-class-omits-section-4.md) | **P1** | The Validator conformance class omits section 4 | `demonstrated` | `accurate` · `accurate` · `unverified` ⚠ split |

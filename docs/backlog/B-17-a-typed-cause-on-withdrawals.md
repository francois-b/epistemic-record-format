...
status: contested
priority: P3
priority_because: "Verification found it already ruled in `non-goals.md`, so the entry needs disposal rather than a ruling."
basis: anticipated
...
verifications:
  - by: "agent/claude-opus-5, verification pass"
    ...
    note: "ruled in non-goals.md 2026-08-22, typed reasons on negative standings"
